...
******/
#define z_BasicTypes_1P_MaxSCRange SDL_INTEGER_LIT(100)
#ifdef XUSESYNONYMIDNODES
...
******/
#define z_BasicTypes_1W_MaxTypeCruiser SDL_INTEGER_LIT(1)
#ifdef XUSESYNONYMIDNODES
...
******/
#define z_BasicTypes_1X_MaxTypeDestroyer SDL_INTEGER_LIT(1)
#ifdef XUSESYNONYMIDNODES
...
******/
#define z_BasicTypes_1Y_MaxTypeMissileCutter SDL_INTEGER_LIT(1)
#ifdef XUSESYNONYMIDNODES
...
******/
#define z_BasicTypes_20_MaxTypePatrolBoat SDL_INTEGER_LIT(3)
#ifdef XUSESYNONYMIDNODES
extern XCONST struct xSynonymIdStruct ySynR_z_BasicTypes_20_MaxTypePatrolBoat;
#endif
...
******/
#define z_BasicTypes_21_AmountStrategy SDL_INTEGER_LIT(2)
#ifdef XUSESYNONYMIDNODES
...
#define z_BasicTypes_0S5_PATROL_BOAT 5
...
******/
extern tSDLStructInfo ySDL_z_BasicTypes_0W_tShipCurrentState;
typedef struct z_BasicTypes_0W_tShipCurrentState_s {
    z_BasicTypes_1I_tShipId  ShipId;
    z_BasicTypes_1J_tStrategyId  StrategyId;
    z_BasicTypes_0S_tNameShip  TypeShip;
    z_BasicTypes_17_tSCMaxSpeed  Speed;
    ...
    z_BasicTypes_1H_tFactorAcceleration  deceleration;
    SDL_Boolean  changeDirection;
    z_BasicTypes_0U_tCoordinates  fightCoordinates;
} z_BasicTypes_0W_tShipCurrentState;
...
typedef struct {
    z_BasicTypes_0X_tShipCharacter  A[6];
...
typedef struct z_BasicTypes_13_tStringShipCurrentState_ystruct {
  ...
  z_BasicTypes_0W_tShipCurrentState Data;
...
#define ANY_z_BasicTypes_0S_tNameShip (z_BasicTypes_0S_tNameShip)(0 + \
  GETINTRAND%((int)(z_BasicTypes_0S5_PATROL_BOAT)+1))
#endif
#define z_BasicTypes_0SB_copy(P)  P
...
******/
YPRD_PROTOTYPE(z_BasicTypes_0SC_ns2i)
extern XCONST struct xPrdIdStruct yPrdR_z_BasicTypes_0SC_ns2i;
#define yPrdN_z_BasicTypes_0SC_ns2i  (&yPrdR_z_BasicTypes_0SC_ns2i)
#ifdef XBREAKBEFORE
#define ySym_z_BasicTypes_0SC_ns2i  7
extern char * yRef_z_BasicTypes_0SC_ns2i (int, xSymbolType *);
#endif
typedef struct {
    PROCEDURE_VARS
                /* #SDTREF(SDL,C:\Testing\Battleships\Packages\BasicTypes.sun(2),248(80,115),13,10) */
    z_BasicTypes_0S_tNameShip z_BasicTypes_0SC0_lit;
    SDL_Integer *z_BasicTypes_0SC_ProcedureResult;
    z_BasicTypes_0S_tNameShip  yDcn_z_BasicTypes_0S_tNameShip;
} yVDef_z_BasicTypes_0SC_ns2i;
typedef yVDef_z_BasicTypes_0SC_ns2i  *yVDP_z_BasicTypes_0SC_ns2i;
extern void yFree_z_BasicTypes_0SC_ns2i (void *);
...
******/
#ifndef XOPTFPAR
extern XCONST struct xVarIdStruct yVarR_z_BasicTypes_0SC0_lit;
#endif
...
******/
YPRD_PROTOTYPE(z_BasicTypes_0SD_i2ns)
extern XCONST struct xPrdIdStruct yPrdR_z_BasicTypes_0SD_i2ns;
#define yPrdN_z_BasicTypes_0SD_i2ns  (&yPrdR_z_BasicTypes_0SD_i2ns)
#ifdef XBREAKBEFORE
#define ySym_z_BasicTypes_0SD_i2ns  7
extern char * yRef_z_BasicTypes_0SD_i2ns (int, xSymbolType *);
#endif
typedef struct {
    PROCEDURE_VARS
                /* #SDTREF(SDL,C:\Testing\Battleships\Packages\BasicTypes.sun(2),248(80,115),16,10) */
    SDL_Integer z_BasicTypes_0SD0_int;
    z_BasicTypes_0S_tNameShip *z_BasicTypes_0SD_ProcedureResult;
} yVDef_z_BasicTypes_0SD_i2ns;
typedef yVDef_z_BasicTypes_0SD_i2ns  *yVDP_z_BasicTypes_0SD_i2ns;
extern void yFree_z_BasicTypes_0SD_i2ns (void *);
...
******/
#ifndef XOPTFPAR
extern XCONST struct xVarIdStruct yVarR_z_BasicTypes_0SD0_int;
#endif
...
******/
#ifndef XOPTFPAR
extern XCONST struct xVarIdStruct yVarR_z_BasicTypes_0SD_ProcedureResult;
#endif
...
******/
#ifndef XOPTSORT
extern XCONST struct xSortIdStruct ySrtR_z_BasicTypes_0W_tShipCurrentState;
#define ySrtN_z_BasicTypes_0W_tShipCurrentState  (&ySrtR_z_BasicTypes_0W_tShipCurrentState)
#endif

#define yAssF_z_BasicTypes_0W_tShipCurrentState(V,E,A)  V = *(z_BasicTypes_0W_tShipCurrentState *)(E)
#define yEq_z_BasicTypes_0W_tShipCurrentState(Expr1,Expr2) GenericEqualSort((void *)Expr1,(void *)Expr2,(tSDLTypeInfo *)&ySDL_z_BasicTypes_0W_tShipCurrentState)
#define yEqF_z_BasicTypes_0W_tShipCurrentState(Expr1,Expr2)  yEq_z_BasicTypes_0W_tShipCurrentState(Expr1,Expr2)
#define yNEqF_z_BasicTypes_0W_tShipCurrentState(Expr1,Expr2)  ( ! yEq_z_BasicTypes_0W_tShipCurrentState(Expr1,Expr2) )
#ifndef ANY_z_BasicTypes_0W_tShipCurrentState
#define ANY_z_BasicTypes_0W_tShipCurrentState(R) (z_BasicTypes_0W_tShipCurrentState *)GenericAnySort(R, (tSDLTypeInfo *)&ySDL_z_BasicTypes_0W_tShipCurrentState)
#endif
#define z_BasicTypes_0W03_copy(P)  P
...
#define yFirst_z_BasicTypes_13_tStringShipCurrentState(P1,Result) (z_BasicTypes_0W_tShipCurrentState*)GenString_First((xString_Type *)P1,&ySDL_z_BasicTypes_13_tStringShipCurrentState,Result)
#define yLast_z_BasicTypes_13_tStringShipCurrentState(P1,Result) (z_BasicTypes_0W_tShipCurrentState*)GenString_Last((xString_Type *)P1,&ySDL_z_BasicTypes_13_tStringShipCurrentState,Result)
...
#define yExtr_z_BasicTypes_13_tStringShipCurrentState(V1,V2) ((z_BasicTypes_0W_tShipCurrentState *)GenString_Extract((xString_Type *)V1,V2,&ySDL_z_BasicTypes_13_tStringShipCurrentState))
#define yAddr_z_BasicTypes_13_tStringShipCurrentState(V1,V2) ((z_BasicTypes_0W_tShipCurrentState *)GenString_Extract((xString_Type *)V1,V2,&ySDL_z_BasicTypes_13_tStringShipCurrentState))
