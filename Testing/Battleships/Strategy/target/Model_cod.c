...
static tSDLSignalParaInfo fSDL_DestroyShip[] = {
  {(tSDLTypeInfo *)&ySDL_z_BasicTypes_1I_tShipId, xOffsetOf(yPDef_DestroyShip,
    Param1)},
  {(tSDLTypeInfo *)&ySDL_z_BasicTypes_1J_tStrategyId,
...
tSDLSignalInfo * xSignalList[] = {&ySDL_FinishSimulation,
  ...
  &ySDL_StrategyLose, &ySDL_messageLog, &ySDL_messageError, 0};
xSignalIdNode xSignalIdList[] = {&ySigR_z_BasicTypes_04_FinishSimulation,
  ...
  &ySigR_z_BasicTypes_0J_messageLog, &ySigR_z_BasicTypes_0K_messageError, 0};
